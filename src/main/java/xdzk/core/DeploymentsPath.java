...
/**
 * Builder object for paths under {@link Paths#DEPLOYMENTS}. {@code DeploymentsPath}
...
public class DeploymentsPath {
	...
	/**
	 * Construct a {@code DeploymentsPath}. Use of this constructor means
	 * that a path will be created via {@link #build()} or
	...
	/**
	 * Construct a {@code DeploymentsPath}. Use of this constructor means
	 * that an existing path will be provided and this object will
	 * be used to extract the individual elements of the path.
	 * Both full paths (including and excluding the
	...
	/**
	 * Build the path string using the field values, including
